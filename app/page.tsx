...
const PRESETS = [
  ...
  {
    id: "eu-latam",
    label: "EU + LatAm (Google/Bing)",
    countries: ["España","Portugal","Francia","Alemania","Italia","México","Argentina","Colombia","Perú","Chile"],
    engines: ["google","bing"],
    structure: "subfolder",
  },
  {
  ...
  {
    id: "dach-cee",
    label: "DACH + CEE (Google + Seznam + Yandex)",
    countries: ["Alemania","Austria","Suiza","República Checa","Polonia","Ucrania"],
    engines: ["google","seznam","yandex"],
    structure: "subfolder",
  },
  {
    id: "mena",
    label: "MENA (Google)",
    countries: ["Emiratos Árabes Unidos","Arabia Saudí","Qatar","Egipto","Marruecos"],
    engines: ["google"],
    structure: "subdomain",
  },
  {
...
const LEGAL_BY_COUNTRY: Record<string, string[]> = {
  ...
  "Estados Unidos": ["CPRA/CCPA", "COPPA (si aplica)", "State privacy acts"],
  "Canadá": ["PIPEDA"],
  "Brasil": ["LGPD"],
  "México": ["LFPDPPP"],
...
const STORAGE_KEY = "intl_seo_roadmap_next_v2";
...
export default function Page() {
  ...
  const [phases, setPhases] = useState<any[]>(BASE_PHASES);
